...
var VideoPlayer = function () {
    ...
    this.contentIndex = 0;
    this.contentUrls = ['http://techslides.com/demos/sample-videos/small.mp4',
...
VideoPlayer.prototype.nextVideo_ = function () {
    console.log('this.contentUrls', this.contentUrls, ' this.contentIndex', this.contentIndex );
    this.contentIndex = this.contentIndex += 1;
    if (this.contentIndex > this.contentUrls.length - 1) { // loop around
        this.contentIndex = 0;
    }
    console.log('this.contentUrls next is:', this.contentUrls, ' this.contentIndex', this.contentIndex );
    this.contentPlayer.src = this.contentUrls[this.contentIndex];
    this.contentPlayer.load();
    this.contentPlayer.play();
};